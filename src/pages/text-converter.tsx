  ...
  const convertText = async () => {
    ...
    try {
      ...
      switch (selectedConverter) {
        case 't2s':
          result = OpenCC.Converter({ from: 'tw', to: 'cn' })(inputText);
          break;
        case 's2t':
          result = OpenCC.Converter({ from: 'cn', to: 'tw' })(inputText);
          break;
        case 't2tw':
          result = OpenCC.Converter({ from: 'hk', to: 'tw' })(inputText);
          break;
        case 's2tw':
          result = OpenCC.Converter({ from: 'cn', to: 'tw' })(inputText);
          break;
        case 't2hk':
          result = OpenCC.Converter({ from: 'tw', to: 'hk' })(inputText);
          break;
        case 's2hk':
          result = OpenCC.Converter({ from: 'cn', to: 'hk' })(inputText);
          break;
        case 't2jp':
          result = OpenCC.Converter({ from: 'tw', to: 'jp' })(inputText);
          break;
        case 's2jp':
          result = OpenCC.Converter({ from: 'cn', to: 'jp' })(inputText);
          break;
        default:
          result = OpenCC.Converter({ from: 'cn', to: 'tw' })(inputText);
      }

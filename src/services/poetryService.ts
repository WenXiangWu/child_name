  ...
  private readonly DATA_SOURCES = [
    {
      ...
      name: '诗经',
      files: [getStaticUrl('poetry/chinese-poetry/诗经/shijing.json')],
      dynasty: '先秦'
    },
    {
      ...
      name: '唐诗',
      files: [
        getStaticUrl('poetry/chinese-poetry/全唐诗/poet.tang.0.json'),
        getStaticUrl('poetry/chinese-poetry/全唐诗/poet.tang.1000.json'),
        getStaticUrl('poetry/chinese-poetry/全唐诗/poet.tang.2000.json'),
        getStaticUrl('poetry/chinese-poetry/全唐诗/poet.tang.3000.json'),
        getStaticUrl('poetry/chinese-poetry/全唐诗/poet.tang.4000.json')
      ],
      dynasty: '唐代',
      limit: 5000 // 限制加载数量
    },
    {
      ...
      name: '宋词',
      files: [
        getStaticUrl('poetry/chinese-poetry/宋词/ci.song.0.json'),
        getStaticUrl('poetry/chinese-poetry/宋词/ci.song.1000.json'),
        getStaticUrl('poetry/chinese-poetry/宋词/ci.song.2000.json')
      ],
      dynasty: '宋代',
      limit: 3000
    },
    {
      ...
      name: '元曲',
      files: [getStaticUrl('poetry/chinese-poetry/元曲/yuanqu.json')],
      dynasty: '元代',
    ...
    },
    {
      ...
      name: '楚辞',
      files: [getStaticUrl('poetry/chinese-poetry/楚辞/chuci.json')],
      dynasty: '战国'
    },
    {
      category: PoetryCategory.LUNYU,
      name: '论语',
      files: [getStaticUrl('poetry/chinese-poetry/论语/lunyu.json')],
      dynasty: '春秋'
    },
    {
      ...
      name: '蒙学',
      files: [
        getStaticUrl('poetry/chinese-poetry/蒙学/sanzijing-new.json'),
        getStaticUrl('poetry/chinese-poetry/蒙学/baijiaxing.json'),
        getStaticUrl('poetry/chinese-poetry/蒙学/qianziwen.json'),
        getStaticUrl('poetry/chinese-poetry/蒙学/dizigui.json')
      ],
      dynasty: '历代',
    ...
    },
    {
      ...
      name: '纳兰性德',
      files: [getStaticUrl('poetry/chinese-poetry/纳兰性德/纳兰性德诗集.json')],
      dynasty: '清代'
    },
    {
      category: PoetryCategory.SHUIMOTANGSHI,
      name: '水墨唐诗',
      files: [getStaticUrl('poetry/chinese-poetry/水墨唐诗/shuimotangshi.json')],
      dynasty: '唐代'
    },
    {
      category: PoetryCategory.CAOCAO,
      name: '曹操诗集',
      files: [getStaticUrl('poetry/chinese-poetry/曹操诗集/caocao.json')],
      dynasty: '三国'
    },
    {
      category: PoetryCategory.YOUMENGYING,
      name: '幽梦影',
      files: [getStaticUrl('poetry/chinese-poetry/幽梦影/youmengying.json')],
      dynasty: '清代'
    },
    {
      ...
      name: '四书五经',
      files: [
        getStaticUrl('poetry/chinese-poetry/四书五经/daxue.json'),
        getStaticUrl('poetry/chinese-poetry/四书五经/zhongyong.json'),
        getStaticUrl('poetry/chinese-poetry/四书五经/mengzi.json')
      ],
      dynasty: '先秦'
    },
    {
      ...
      name: '御定全唐詩',
      files: [
        getStaticUrl('poetry/chinese-poetry/御定全唐詩/json/801.json'),
        getStaticUrl('poetry/chinese-poetry/御定全唐詩/json/802.json'),
        getStaticUrl('poetry/chinese-poetry/御定全唐詩/json/803.json'),
        getStaticUrl('poetry/chinese-poetry/御定全唐詩/json/804.json'),
        getStaticUrl('poetry/chinese-poetry/御定全唐詩/json/805.json'),
        getStaticUrl('poetry/chinese-poetry/御定全唐詩/json/806.json'),
        getStaticUrl('poetry/chinese-poetry/御定全唐詩/json/807.json'),
        getStaticUrl('poetry/chinese-poetry/御定全唐詩/json/808.json'),
        getStaticUrl('poetry/chinese-poetry/御定全唐詩/json/809.json'),
        getStaticUrl('poetry/chinese-poetry/御定全唐詩/json/810.json')
      ],
      dynasty: '唐代',
    ...
    },
    {
      ...
      name: '五代诗词',
      files: [
        getStaticUrl('poetry/chinese-poetry/五代诗词/nantang/poetrys.json'),
        getStaticUrl('poetry/chinese-poetry/五代诗词/huajianji/huajianji-1-juan.json'),
        getStaticUrl('poetry/chinese-poetry/五代诗词/huajianji/huajianji-2-juan.json'),
        getStaticUrl('poetry/chinese-poetry/五代诗词/huajianji/huajianji-3-juan.json')
      ],
      dynasty: '五代',
      limit: 1000
    }
